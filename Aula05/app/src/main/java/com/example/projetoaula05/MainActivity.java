    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                double peso = Double.parseDouble(editPeso.getText().toString()); //Pega o valor armazenado no editPeso (que foi lido como String) e converte para o Double (função do parseDouble)
