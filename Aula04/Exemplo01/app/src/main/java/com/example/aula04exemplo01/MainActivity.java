...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        livro1 = new Livro ("Desenvolvendo seu Primeiro Aplicativo Android.", "Luiz Carlos", 2021);
        livro2 = new Livro ("Programação de Jogos Android.", "Edgar", 2067);
        livro3 = new Livro ("Desenvolvimentos de Aplicativos.", "Desconhecido", 2069);
